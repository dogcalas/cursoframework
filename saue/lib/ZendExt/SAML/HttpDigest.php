...
class ZendExt_SAML_HttpDigest
{
     ...
     * @return str
     */
    function authenticate($users,$pass)
    {
        ...
        if ($authorization) {
            ...
            if (
                ...
                if (
					...
					$arregloprueba[0]= $response[1];
					$arregloprueba[1]= $expectedResponse;
					echo"<pre>"; print_r($arregloprueba);die;
