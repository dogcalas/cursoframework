...
class ezcWorkflowNodeAction extends ezcWorkflowNode
{
    ...
    //protected $service_dir=null;   //atributo agregado para especificar la direccion del servicio que debe levantarse
    ...
    public function __construct( $configuration )
    {
        ...
        /*
         * My own:
         * optionally I check whether the passed object implements
         * ezcWorkflowServiceObject interface
         */
        if($configuration instanceof ezcWorkflowServiceObject){
    ...
    public function execute( ezcWorkflowExecution $execution )
    {
        ...
        $finished = $this->object->execute($execution);
