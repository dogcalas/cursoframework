...
class ZendExt_WF_WFTranslatorXPDL_Clases_TriggerResultLink extends ZendExt_WF_WFTranslatorXPDL_Base_Base {
    ...
    public function toXPDL($doc, &$objectTag) {
        $thisObjectTag = $doc->createElement("TriggerResultLink");
