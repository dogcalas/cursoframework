...
class ZendExt_File
{
	 ...
	 * @return array
	 */
	public function ls($path = null, $withroot = true)
	{
		$this->test_var($path, $this->path);
	 ...
	 * @return array
	 */
	public function lsd($path = null, $withroot = true)
	{
		$this->test_var($path, $this->path);
	 ...
	 * @return array
	 */
	public function ll($path = null, $withroot = true)
	{
		$this->test_var($path, $this->path);
	 ...
	 * @return array
	 */
	public function lld($path = null, $withroot = true)
	{
		$this->test_var($path, $this->path);
