<?php
	...
	class ZendExt_Trace_Container_IoCException extends ZendExt_Trace_Container_Log {
		...
		*/
		 ...
		 * @param String $pHora
		 */
		function __construct($pExceptionCode, $pExceptionMsg, $pExceptionDescription, $pSource, $pTarget, $pClass, $pMethod, $pAction, $pLog, $pController, $pIpHost, $pIdRol, $pIdDominio, $pUser, $pIdCommonStructure, $pRol, $pDominio, $pEstructura, $pFecha = null, $pHora = null) {
			parent :: __construct ($pIpHost, $pIdRol, $pIdDominio, $pUser, $pIdCommonStructure, $pRol, $pDominio, $pEstructura, $pFecha, $pHora);
			parent :: setTraceType(5);
