...
/**
 * @see ZendExt_CodeGenerator_Php_Docblock_Tag_Param
 */
require_once 'ZendExt/CodeGenerator/Php/Docblock/Tag/Param.php';

/**
 * @see ZendExt_CodeGenerator_Php_Docblock_Tag_Return
 */
require_once 'ZendExt/CodeGenerator/Php/Docblock/Tag/Return.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class ZendExt_CodeGenerator_Php_Docblock_Tag extends ZendExt_CodeGenerator_Php_Abstract
{
     ...
     * @return ZendExt_CodeGenerator_Php_Docblock_Tag
     */
    ...
    public static function getPluginLoader()
    {
        if (self::$_pluginLoader == null) {
            ...
            self::setPluginLoader(new Zend_Loader_PluginLoader(array(
                'ZendExt_CodeGenerator_Php_Docblock_Tag' => dirname(__FILE__) . '/Tag/'))
                );
        }
    ...
    public static function factory($tagName)
    {
        ...
        try {
            ...
            $tagClass = 'ZendExt_CodeGenerator_Php_Docblock_Tag';
        }
