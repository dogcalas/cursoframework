...
/**
 * @see ZendExt_CodeGenerator_Php_Docblock_Tag
 */
require_once 'ZendExt/CodeGenerator/Php/Docblock/Tag.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class ZendExt_CodeGenerator_Php_Docblock extends ZendExt_CodeGenerator_Php_Abstract
{
    /**
     * @var string
     */
    ...
    public static function fromReflection(Zend_Reflection_Docblock $reflectionDocblock)
    {
        ...
        foreach ($reflectionDocblock->getTags() as $tag) {
            $docblock->setTag(ZendExt_CodeGenerator_Php_Docblock_Tag::fromReflection($tag));
        }
     ...
     * setTag()
     *
     * @param array|ZendExt_CodeGenerator_Php_Docblock_Tag $tag
     * @return ZendExt_CodeGenerator_Php_Docblock
     */
    public function setTag($tag)
    {
        if (is_array($tag)) {
            $tag = new ZendExt_CodeGenerator_Php_Docblock_Tag($tag);
        } elseif (!$tag instanceof ZendExt_CodeGenerator_Php_Docblock_Tag) {
            require_once 'ZendExt/CodeGenerator/Php/Exception.php';
            throw new ZendExt_CodeGenerator_Php_Exception(
                'setTag() expects either an array of method options or an '
                . 'instance of ZendExt_CodeGenerator_Php_Docblock_Tag'
                );
        }
     ...
     * getTags
     *
     * @return array Array of ZendExt_CodeGenerator_Php_Docblock_Tag
     */
