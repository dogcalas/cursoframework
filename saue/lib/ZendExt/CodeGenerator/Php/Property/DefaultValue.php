 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class ZendExt_CodeGenerator_Php_Property_DefaultValue extends ZendExt_CodeGenerator_Php_Abstract
{
    /**#@+
     * Constant values
     */
        ...
        if ($type == self::TYPE_AUTO) {
            ...
            if ($type == self::TYPE_ARRAY) {
                ...
                foreach ($rii as $curKey => $curValue) {
                    if (!$curValue instanceof ZendExt_CodeGenerator_Php_Property_DefaultValue) {
