...
function dTree(objName) {
	...
	this.icon = {
		...
		root			: perfil.dirImg+'organigrama/base.gif',

		folder			: perfil.dirImg+'organigrama/folder.gif',

		folderOpen		: perfil.dirImg+'organigrama/folderopen.gif',

		node			: perfil.dirImg+'organigrama/page.gif',

		empty			: perfil.dirImg+'organigrama/empty.gif',

		line			: perfil.dirImg+'organigrama/line.gif',

		join			: perfil.dirImg+'organigrama/join.gif',

		joinBottom		: perfil.dirImg+'organigrama/joinbottom.gif',

		plus			: perfil.dirImg+'organigrama/plus.gif',

		plusBottom		: perfil.dirImg+'organigrama/plusbottom.gif',

		minus			: perfil.dirImg+'organigrama/minus.gif',

		minusBottom		: perfil.dirImg+'organigrama/minusbottom.gif',

		nlPlus			: perfil.dirImg+'organigrama/nolines_plus.gif',

		nlMinus			: perfil.dirImg+'organigrama/nolines_minus.gif',
		
		middleLine		: perfil.dirImg+'organigrama/myline2.gif',
		
		leftLine		: perfil.dirImg+'organigrama/myline2.gif',
		
		smallLine		: perfil.dirImg+'organigrama/smallLine.gif',
		
		rightLine		: perfil.dirImg+'organigrama/myline2.gif'
...
dTree.prototype.node = function(node, nodeId) {
	...
	str += '<table border="0" bordercolor="#009999" cellpadding="0" cellspacing="0" width="100%" >';
	str += '<tr>';
	...
	str+="</td></tr><tr><td valign=top  align=center style='white-space:nowrap'><div style='margin-left:10px;margin-right:30px;width:90%;background-color:#FFFFCC;border:#000000 1px solid;float:right;color:#000000;text-align:center;height:30px;padding-top:5px;background-image:url("+perfil.dirImg+"organigrama/fondo.gif)'>";
	if (node.url) {

		str += '<label id="s' + this.obj + nodeId + '" class="' + ((this.config.useSelection) ? ((node._is ? 'nodeSel' : 'node')) : 'node') +'"';

		/*if (node.title) str += ' title="' + node.title + '"';

		if (node.target) str += ' target="' + node.target + '"';*/

		//if (this.config.useStatusText) str += ' onmouseover="javascript:\'' + alert("ds") + '\';return true;" onmouseout="window.status=\'\';return true;" ';
		...
		str += '<label href="javascript: ' + this.obj + '.o(' + nodeId + ');" class="node"> ';

		
	str += '<div class="orgadiv"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+node.name+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
	if (node.url || ((!this.config.folderLinks || !node.url) && node._hc)) str += '</div></label>';
	str += '</div>';
