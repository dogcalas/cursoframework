...
Ext.define('Ext.ux.desktop.Desktop', {
    ...
    initComponent: function () {
		...
		//linea para poner la barra superoir o inferior
        me.tbar = me.taskbar = new Ext.ux.desktop.TaskBar(me.taskbarConfig);
    ...
    createWindowMenu: function () {
        ...
        return {
            defaultAlign: 'br-tr',
            items: [
                { text: 'Restaurar', handler: me.onWindowMenuRestore, scope: me },
                { text: 'Minimizar', handler: me.onWindowMenuMinimize, scope: me },
                { text: 'Maximizar', handler: me.onWindowMenuMaximize, scope: me },
                '-',
                { text: 'Cerrar', handler: me.onWindowMenuClose, scope: me }
            ],
            listeners: {
    ...
    updateActiveWindow: function () {
        ...
        if (activeWindow) {
            ...
            window.idFuncionalidad= activeWindow.funt;
        }
