...
Ext.define('Ext.ux.desktop.TaskBar', {
    ...
    initComponent: function () {
       ...
       // me.quickStart = new Ext.toolbar.Toolbar(me.getQuickStart());
        ...
        me.items = [
            {
                ...
                overCls: 'ux-btn-fo',
                 scale   : 'medium',
                menuActiveCls:'btn-presionado-inicio',
                menu: me.startMenu,
        ...
        me.callParent();
        // me.container.el.addCls('sin-borde');
        me.startMenu.on('afterrender',function(){
            me.startMenu.hide();
            me.startMenu.show();
            me.startMenu.getEl().on('mousedown', function() {
                me.startMenu.hide();
                me.startMenu.show();
            })
        })
    ...
    getQuickStart: function () {
        ...
        Ext.each(this.quickStart, function (item) {
            ret.items.push({
                tooltip: { text: item.name, align: 'tl-bl?' },
                //tooltip: item.name,
    ...
    addTaskButton: function(win) {
        var config = {
            ...
            toggleGroup: 'all',
            cls: 'tarea-barra',
            overCls: 'tarea-barra-hover',
            pressedCls:'tarea-barra-activa',
            width: 140,
            margins: '0 2 0 3',
