...
Ext.UCID.idiomaHeader=function(columnas,perfil){
    
    for(var i=0;i<columnas.length;i++){
                    switch (columnas[i].header){
                        case 'Servidor':{                                
                                columnas[i].header=perfil.lbNombreColumServidor;
                                break;
                        }                       
                        case 'Gestor':{                                
                                columnas[i].header=perfil.lbNombreColumGestor;
                                break;
                        }                        
                         case 'Base De Datos':{                                  
                                columnas[i].header=perfil.lbNombreColumBD;
                                break;
                        }
                         case 'Base de datos':{                                  
                                columnas[i].header=perfil.lbNombreColumBD;
                         ...
                         case 'Esquema':{                                
                                columnas[i].header=perfil.lbNombreColumEsquema;
                                break;
                        }
                         case 'Esquemas':{                                
                                columnas[i].header=perfil.lbNombreColumEsquema;
                          ...
                          case 'Tabla':{                                
                                columnas[i].header=perfil.lbNombreColumTabla;
                                break;
                        }
                         case 'Tablas':{                                
                                columnas[i].header=perfil.lbNombreColumTabla;
                         ...
                         case 'Vista':{                                
                                columnas[i].header=perfil.lbNombreColumVista;
                                break;
                        }
                         case 'Vistas':{                                
                                columnas[i].header=perfil.lbNombreColumVista;
                          ...
                          case 'Secuencia':{                                
                                columnas[i].header=perfil.lbNombreColumSec;
                                break;
                        }
                         case 'Secuencias':{                                
                                columnas[i].header=perfil.lbNombreColumSec;
                         ...
                         case 'Funciones':{                                
                                columnas[i].header=perfil.lbNombreColumFun;
                                break;
                        }
                         case 'Servicio':{                                
                                columnas[i].header=perfil.lbNombreColumServicio;
                                break;
                        }
                         case 'Subsistema':{                                
                                columnas[i].header=perfil.lbNombreColumSubsist;
                                break;
                        }
                    }                   
      }   
