		...
		var idsistema,idrol,nodo,gridRol,sm,letrasnumeros,smrol;
        ...
        {	
                ////------------ Botones ------------////
		btnguardarcambios = new Ext.Button({disabled:true,icon:perfil.dirImg+'aceptar.png',iconCls:'btn',text:perfil.etiquetas.lbBtnSalvar});
	    ...
	    padreArbolDominios= new Ext.tree.AsyncTreeNode({
	          text: perfil.etiquetas.lbRootNodeArbolDominios,
	          expandable:false,
	          id:'0'
	    });         
