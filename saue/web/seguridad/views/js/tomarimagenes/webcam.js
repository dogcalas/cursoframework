...
window.webcam = {
    ...
    swf_url: '../../views/js/tomarimagenes/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
    ...
    get_html: function(width, height, server_width, server_height) {
        ...
        if (this.ie) {
            ...
            html += '<embed id="webcam_movie"  wmode="transparent" src="'+this.swf_url+'" loop="false" menu="false" quality="best" bgcolor="#000000" width="'+width+'" height="'+height+'" name="webcam_movie" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" flashvars="'+flashvars+'" />';
        }
        ...
        switch (type) {
            ...
            case 'error':
                ...
                if (!this.fire_hook('onError', msg)) {
                    //alert("JPEGCam Flash Error:johi " );
            ...
            case 'success':
                ...
                this.fire_hook('onComplete', msg);
                if(msg == 'success'){
                    mostrarMensaje(1,perfil.etiquetas.lbSucces);
