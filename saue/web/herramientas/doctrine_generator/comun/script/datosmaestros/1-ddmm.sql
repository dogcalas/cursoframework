...
CREATE ROLE configuracionsigis NOSUPERUSER NOINHERIT NOCREATEDB NOCREATEROLE LOGIN; 
ALTER role configuracionsigis ENCRYPTED PASSWORD 'md523f27ef5329e3034747469e6e2478c9d';
...
VALUES ('V5.0.0', 'V5.0.0','mod_datosmaestros',null,'C','R','I');
