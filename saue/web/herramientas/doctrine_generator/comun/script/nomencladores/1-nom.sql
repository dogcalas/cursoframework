...
CREATE ROLE nomencladorsigis NOSUPERUSER NOINHERIT NOCREATEDB NOCREATEROLE LOGIN; 
ALTER role nomencladorsigis ENCRYPTED PASSWORD 'md5f59d0b47b7b6b0926dea494e8b34a2c4';
...
VALUES ('V5.0.0', 'V5.0.0','mod_nomencladores',null,'C','R','I');
