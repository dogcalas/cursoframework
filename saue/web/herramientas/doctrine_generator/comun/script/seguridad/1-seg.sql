...
CREATE ROLE seguridadsigis NOSUPERUSER NOINHERIT NOCREATEDB NOCREATEROLE LOGIN; 
ALTER role seguridadsigis ENCRYPTED PASSWORD 'md59f01848bc835392c708237708767c2f2';
...
VALUES ('V5.0.0', 'V5.0.0','mod_seguridad',null,'C','R','I');
