...
CREATE ROLE trazasigis NOSUPERUSER NOINHERIT NOCREATEDB NOCREATEROLE LOGIN; 
ALTER role trazasigis ENCRYPTED PASSWORD 'md53fc533c3295c7a85fd11b16cd9b7aecb';
...
VALUES ('V5.0.0', 'V5.0.0','mod_traza',null,'C','R','I');
