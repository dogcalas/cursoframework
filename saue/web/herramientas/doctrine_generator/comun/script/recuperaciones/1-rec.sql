...
CREATE ROLE reportesigis NOSUPERUSER NOINHERIT NOCREATEDB NOCREATEROLE LOGIN; 
ALTER role reportesigis ENCRYPTED PASSWORD 'md5a2cddb6ec7f996b9cfd710e789e38dc9';
...
VALUES ('V5.0.0', 'V5.0.0','mod_recuperaciones',null,'C','R','I');
