...
var MD5=(function(){
    ...
    var binl2b64=function(binarray){
        ...
        for(var i=0;i<binarray.length*4;i+=3){
            triplet=(((binarray[i>>2]>>8*(i%4))&255)<<16)
...
(function(callback){
        ...
        serialize:function(elem){
            ...
            for(i=0;i<elem.attributes.length;i++){
                if(elem.attributes[i].nodeName!="_realname"){
                    ...
                    +"='"
                    +elem.attributes[i].value.replace(/&/g,"&amp;").replace(/\'/g,"&apos;").replace(/</g,"&lt;")
                    +"'"
                }
            }
    ...
    Strophe.Connection.prototype={
        ...
        connect:function(jid,pass,callback,wait,hold){
            ...
            this._requests.push(new Strophe.Request(body.tree(),this._onRequestStateChange.bind(this,this._connect_cb.bind(this)),body.tree().getAttribute("rid")));
