...
class SimpleSAML_Metadata_MetaDataStorageHandler {
	...
	public function getMetaDataConfig($entityId, $set) {
		...
		//$dir_file = __FILE__;
		//$mydir = str_replace("lib/SimpleSAML/Metadata/MetaDataStorageHandler.php", "config/config.php", $dir_file);
		$mydir = $_SERVER['DOCUMENT_ROOT'].'/saml/config/config.php';
		$myobjconfig = SimpleSAML_Configuration::loadFromFile($mydir,TRUE);
		$myconfig = $myobjconfig->getMyConfigValue();
		if($set== 'saml20-sp-remote'){
			$metadata = array('AssertionConsumerService' => $myconfig['ecotec.config']['idpmetadataonsamlspremote'].'/'.$myconfig['ecotec.config']['appname'].'/module.php/saml/sp/saml2-acs.php/ecotec',
							  'SingleLogoutService' => $myconfig['ecotec.config']['idpmetadataonsamlspremote'].'/'.$myconfig['ecotec.config']['appname'].'/module.php/saml/sp/saml2-logout.php/ecotec',
							  'entityid' => $entityId,
							  'metadata-index' => $entityId,
							  'metadata-set' => $set
				);
		}
		if($set== 'saml20-idp-remote'){
				
				$metadata = array('SingleSignOnService' => $myconfig['ecotec.config']['idpmetadataonsamlspremote'].'/'.$myconfig['ecotec.config']['appname'].'/saml2/idp/SSOService.php',
								  'SingleLogoutService' => $myconfig['ecotec.config']['idpmetadataonsamlspremote'].'/'.$myconfig['ecotec.config']['appname'].'/saml2/idp/SingleLogoutService.php',
								  'certFingerprint'	=> $myconfig['ecotec.config']['secure']['certFingerprint'],
								  'entityid' => $entityId,
								  'metadata-index' => $entityId,
								  'metadata-set' => $set
				);
		...
		if($set== 'saml20-idp-hosted'){
				$metadata = array('host' => '__DEFAULT__',
								  'privatekey' => $myconfig['ecotec.config']['secure']['privatekey'],
								  'certificate'	=> $myconfig['ecotec.config']['secure']['certificate'],
								  'auth' => $myconfig['ecotec.config']['IdpAuth'],
								  'entityid' => $entityId,
								  'metadata-index' => $entityId,
								  'metadata-set' => $set
				);
