...
class SimpleSAML_Session {
	...
	private static $namespace = 'SimpleSAMLphp_SESSION';
	/**
	...
	public static function getInstance() {
		...
		//echo '<pre>';print_r(self::$namespace);die;
	...
	public static function getSession($sessionId = NULL) {
		...
		$session = $sh->loadSession($sessionId,self::$namespace);
		
		if($session === NULL) {
			
			return NULL;
		}
		//echo '<pre>';print_r($_SESSION.'b');die;
	...
	public function saveSession() {
		...
		try {
			$sh->saveSession($this,self::$namespace);
		} catch (Exception $e) {
			if (!($e instanceof SimpleSAML_Error_Exception)) {
