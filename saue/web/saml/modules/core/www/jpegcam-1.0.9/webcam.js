...
window.webcam = {
	...
	swf_url: 'jpegcam-1.0.9/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'jpegcam-1.0.9/shutter.mp3', // URI to shutter.mp3 sound
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : 'jpegcam-1.0.9/shutter.mp3';
	},
		...
		switch (type) {
			...
			case 'error':
				...
				if (!this.fire_hook('onError', msg)) {                  
                               ...
                               mostrarMensaje(3,'No se ha encontrado ninguna c&aacute;mara.');
