...
abstract class sspmod_core_Auth_UserPassBase extends SimpleSAML_Auth_Source {
	...
	abstract protected function login($username, $password);
     abstract protected function loginface($username, $password);   
	 ...
	 */
	public static function handleLogin($authStateId, $username, $password,$er) {
		...
		try {
			...
			$attributes = $source->login($username, $password);
                         ...
                         $attributes = $source->loginface($username, $password);
