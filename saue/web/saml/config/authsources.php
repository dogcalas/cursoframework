...
$config = array(
	...
	'ecotecsql' => array(
		'sqlauth:SQL',
		'dsn' => 'pgsql:host=localhost;port=5432;dbname=sauxe',
		'username' => 'seguridadsigis',
		'password' => 'seguridadsigis',
		'query' => 'SELECT nombreusuario, contrasenna, idusuario FROM mod_seguridad.seg_usuario WHERE nombreusuario = :username AND contrasenna = MD5(:password)',
	),
