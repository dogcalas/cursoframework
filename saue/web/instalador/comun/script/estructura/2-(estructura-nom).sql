...
VALUES ('V6.0.0', 'V6.0.0','mod_estructuracomp','mod_nomencladores','C','E','I');
-------------------------------------------------------------------------------
...
FROM
 ...
 INNER JOIN mod_nomencladores.nom_especialidad esp ON (e.idespecialidad = esp.idespecialidad)
