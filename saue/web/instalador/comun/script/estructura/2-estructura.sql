...
VALUES ('V6.0.0', 'V6.0.0','mod_estructuracomp',null,'C','E','I');
...
ALTER TABLE mod_estructuracomp.nom_tecnica
  ADD CONSTRAINT nom_tecnica_abrevkey UNIQUE(abrevtecnica);

ALTER TABLE mod_estructuracomp.nom_tecnica
  ADD CONSTRAINT nom_tecnica_denkey UNIQUE(dentecnica);

ALTER TABLE mod_estructuracomp.nom_tipo_calificador
  ADD CONSTRAINT nom_tipo_calificador_abrevkey UNIQUE(abreviatura);

ALTER TABLE mod_estructuracomp.nom_tipo_calificador
  ADD CONSTRAINT nom_tipo_calificador_denkey UNIQUE(denominacion);

ALTER TABLE mod_estructuracomp.nom_tipocifra
  ADD CONSTRAINT nom_tipocifra_denkey UNIQUE(dentipocifra);

ALTER TABLE mod_estructuracomp.nom_tipodoc
  ADD CONSTRAINT nom_tipodoc_denkey UNIQUE(denominacion);

ALTER TABLE mod_estructuracomp.nom_cargocivil
  ADD CONSTRAINT nom_cargocivil_abrevkey UNIQUE(abrevcargociv);

ALTER TABLE mod_estructuracomp.nom_cargocivil
  ADD CONSTRAINT nom_cargocivil_denkey UNIQUE(dencargociv);

ALTER TABLE mod_estructuracomp.nom_gradomilit
  ADD CONSTRAINT nom_gradomilit_abrevkey UNIQUE(abrevgradomilit);

ALTER TABLE mod_estructuracomp.nom_gradomilit
  ADD CONSTRAINT nom_gradomilit_denkey UNIQUE(dengradomilit);

ALTER TABLE mod_estructuracomp.nom_grupocomple
  ADD CONSTRAINT nom_grupocomple_denkey UNIQUE(denominacion);

ALTER TABLE mod_estructuracomp.nom_modulo
  ADD CONSTRAINT nom_modulo_abrevkey UNIQUE(abreviatura);

ALTER TABLE mod_estructuracomp.nom_modulo
  ADD CONSTRAINT nom_modulo_denkey UNIQUE(denmodulo);

ALTER TABLE mod_estructuracomp.nom_organo
  ADD CONSTRAINT nom_organo_abrevkey UNIQUE(abrevorgano);

ALTER TABLE mod_estructuracomp.nom_organo
  ADD CONSTRAINT nom_organo_denkey UNIQUE(denorgano);

ALTER TABLE mod_estructuracomp.nom_calificador_cargo
  ADD CONSTRAINT nom_calificador_cargo_abrevkey UNIQUE(abreviatura);

ALTER TABLE mod_estructuracomp.nom_calificador_cargo
  ADD CONSTRAINT nom_calificador_cargo_denkey UNIQUE(denominacion);

ALTER TABLE mod_estructuracomp.nom_cargomilitar
  ADD CONSTRAINT nom_cargomilitar_abrevkey UNIQUE(abrevcargomilitar);

ALTER TABLE mod_estructuracomp.nom_cargomilitar
  ADD CONSTRAINT nom_cargomilitar_denkey UNIQUE(dencargomilitar);

ALTER TABLE mod_estructuracomp.nom_subordinacion
  ADD CONSTRAINT nom_subordinacion_denkey UNIQUE(denominacion);

ALTER TABLE mod_estructuracomp.nom_prepmilitar
  ADD CONSTRAINT nom_prepmilitar_abrevkey UNIQUE(abrevprepmilitar);

ALTER TABLE mod_estructuracomp.nom_prepmilitar
  ADD CONSTRAINT nom_prepmilitar_denkey UNIQUE(denprepmilitar);

ALTER TABLE mod_estructuracomp.nom_nivel_utilizacion
  ADD CONSTRAINT nom_nivel_utilizacion_abrevkey UNIQUE(abreviatura);

ALTER TABLE mod_estructuracomp.nom_nivel_utilizacion
  ADD CONSTRAINT nom_nivel_utilizacion_denkey UNIQUE(denominacion);

ALTER TABLE mod_estructuracomp.nom_nivelestr
  ADD CONSTRAINT nom_nivelestr_abrevkey UNIQUE(abrevnivelestr);

ALTER TABLE mod_estructuracomp.nom_nivelestr
  ADD CONSTRAINT nom_nivelestr_denkey UNIQUE(dennivelestr);

ALTER TABLE mod_estructuracomp.nom_clasificacion_cargo
  ADD CONSTRAINT nom_clasificacion_cargo_denkey UNIQUE(denominacion);

ALTER TABLE mod_estructuracomp.nom_escalasalarial
  ADD CONSTRAINT nom_escalasalarial_abrevkey UNIQUE(abreviatura);

ALTER TABLE mod_estructuracomp.nom_escalasalarial
  ADD CONSTRAINT nom_escalasalarial_denkey UNIQUE(denominacion);

ALTER TABLE mod_estructuracomp.nom_categocup
  ADD CONSTRAINT nom_categocup_abrevkey UNIQUE(abreviatura);

ALTER TABLE mod_estructuracomp.nom_categocup
  ADD CONSTRAINT nom_categocup_denkey UNIQUE(dencategocup);

ALTER TABLE mod_estructuracomp.nom_categcivil
  ADD CONSTRAINT nom_categcivil_abrevkey UNIQUE(abrevcategcivil);

ALTER TABLE mod_estructuracomp.nom_categcivil
  ADD CONSTRAINT nom_categcivil_denkey UNIQUE(dencategcivil);

ALTER TABLE mod_estructuracomp.nom_agrupacion
  ADD CONSTRAINT nom_agrupacion_abrevkey UNIQUE(abrevagrupacion);

ALTER TABLE mod_estructuracomp.nom_agrupacion
  ADD CONSTRAINT nom_agrupacion_denkey UNIQUE(denagrupacion);

	ALTER TABLE ONLY dat_estructura
		ADD CONSTRAINT dat_estructura_codigo_key UNIQUE (codigo);
		
	ALTER TABLE mod_estructuracomp.nom_nomencladoreavestruc
		ADD CONSTRAINT nom_nomencladoreavestruc_nombrekey UNIQUE(nombre);
...
declare
result mod_estructuracomp.cant_entida_unidades_agrupacion;
id numeric;
EavNivel numeric;
EavAgrup numeric;
EavEntidad numeric;
...
-- Function: mod_estructuracomp."f_ getHijosEstructura"(numeric)

-- DROP FUNCTION mod_estructuracomp."f_ getHijosEstructura"(numeric);
...
-- Function: mod_estructuracomp.f_adicinardom(bigint, bigint)

-- DROP FUNCTION mod_estructuracomp.f_adicinardom(bigint, bigint);
...
-- Function: mod_estructuracomp.f_buscaridcampo(character varying, numeric)

-- DROP FUNCTION mod_estructuracomp.f_buscaridcampo(character varying, numeric);
...
-- Function: mod_estructuracomp.f_contarcargosporgupoescala(character varying, character varying, character varying)

-- DROP FUNCTION mod_estructuracomp.f_contarcargosporgupoescala(character varying, character varying, character varying);
...
-- Function: mod_estructuracomp."f_existeEstructuraop"(numeric)

-- DROP FUNCTION mod_estructuracomp."f_existeEstructuraop"(numeric);
...
-- Function: mod_estructuracomp."f_getEstructurasInternas"(numeric, boolean)

-- DROP FUNCTION mod_estructuracomp."f_getEstructurasInternas"(numeric, boolean);
...
result mod_estructuracomp.td_areas;
...
cargo mod_estructuracomp.td_calificador_cargo;
...
var mod_estructuracomp.td_cargos_areas_categoria;
...
result mod_estructuracomp.td_rep_componentesestructurainterna;
...
result mod_estructuracomp.td_entidades;
...
var mod_estructuracomp.td_grupoescalacategocupacional1;
denom varchar;
codigo varchar;
...
declare
result mod_estructuracomp.td_rep_nivel1porclasif;
id numeric;
EavNivel numeric;
EavAgrup numeric;
EavEntidad numeric;
...
declare
Result mod_estructuracomp.td_rep_relacion_registro_entidad_agrupacion1;
id numeric;
EavNivel numeric;
EavAgrup numeric;
EavEntidad numeric;
...
DECLARE
result mod_estructuracomp.td_rep_relacionagruppornivel1;
id numeric;
EavNivel numeric;
EavAgrup numeric;
EavEntidad numeric;
...
declare
result mod_estructuracomp.td_rep_relacionentidadesporagrupaciones1;
id numeric;
EavNivel numeric;
EavAgrup numeric;
EavEntidad numeric;
...
-- Function: mod_estructuracomp.f_rep_resumen_agrupaciones_nivel_segun_clasificacion(character varying)

-- DROP FUNCTION mod_estructuracomp.f_rep_resumen_agrupaciones_nivel_segun_clasificacion(character varying);
...
declare
result mod_estructuracomp.td_rep_resumen_agrupaciones_nivel;
id numeric;
EavNivel numeric;
EavAgrup numeric;
EavEntidad numeric;
...
-- Function: mod_estructuracomp.f_rep_resumen_categoria_entidades_agrupaciones(character varying)

-- DROP FUNCTION mod_estructuracomp.f_rep_resumen_categoria_entidades_agrupaciones(character varying);
...
declare
result mod_estructuracomp.td_rep_resumen_categoria_entidades_agrupaciones;
id numeric;
EavNivel numeric;
EavAgrup numeric;
EavEntidad numeric;
...
declare
result mod_estructuracomp.td_rep_resumentidporagrupaciporclasificac;
id numeric;
EavNivel numeric;
EavAgrup numeric;
EavEntidad numeric;
...
-- Function: mod_estructuracomp.f_totalgrupoescala(character varying, character varying)

-- DROP FUNCTION mod_estructuracomp.f_totalgrupoescala(character varying, character varying);
...
FROM
 ...
 INNER JOIN mod_estructuracomp.nom_categocup cat ON (nciv.idcategocup = cat.idcategocup)
WHERE
   /* e.denominacion = $1 AND */g.abreviatura = $2 AND e.idestructura = mod_estructuracomp."f_rep_buscaridestructura"($1)
...
-- Function: mod_estructuracomp.posicional(text)

-- DROP FUNCTION mod_estructuracomp.posicional(text);
...
-- Function: mod_estructuracomp.posicionalmitad(numeric)

-- DROP FUNCTION mod_estructuracomp.posicionalmitad(numeric);
...
-- Function: mod_estructuracomp.reordenar_dat_estructura(bigint, bigint)

-- DROP FUNCTION mod_estructuracomp.reordenar_dat_estructura(bigint, bigint);
...
-- Function: mod_estructuracomp.reordenar_dat_estructuraop(bigint, bigint)

-- DROP FUNCTION mod_estructuracomp.reordenar_dat_estructuraop(bigint, bigint);
...
-- Function: mod_estructuracomp.reordenar_nom_dpa(bigint, bigint)

-- DROP FUNCTION mod_estructuracomp.reordenar_nom_dpa(bigint, bigint);
...
-- Function: mod_estructuracomp.rep_contarxclasf(numeric, numeric, numeric)

-- DROP FUNCTION mod_estructuracomp.rep_contarxclasf(numeric, numeric, numeric);
...
CREATE OR REPLACE FUNCTION mod_estructuracomp.f_rep_plantilla_cargos(idestructura numeric)
  RETURNS SETOF mod_estructuracomp.td_plantilla_cargos AS
$BODY$
DECLARE

plantilla mod_estructuracomp.td_plantilla_cargos;
...
$BODY$
 ...
 --
-- TOC entry 122 (class 1255 OID 1540963)
-- Dependencies: 1425 10
-- Name: chequear(); Type: FUNCTION; Schema: mod_estructuracomp; Owner: -
--
...
-- TOC entry 163 (class 1255 OID 1541004)
-- Dependencies: 1425 10
-- Name: ft_actualizacion_arbol(); Type: FUNCTION; Schema: mod_estructuracomp; Owner: -
--
...
--
-- TOC entry 164 (class 1255 OID 1541005)
-- Dependencies: 1425 10
-- Name: ft_actualizacion_arbolop(); Type: FUNCTION; Schema: mod_estructuracomp; Owner: -
--
...
--
-- TOC entry 165 (class 1255 OID 1541006)
-- Dependencies: 1425 10
-- Name: ft_chequear(); Type: FUNCTION; Schema: mod_estructuracomp; Owner: -
--
...
--
-- TOC entry 166 (class 1255 OID 1541007)
-- Dependencies: 1425 10
-- Name: ft_eliminar_nodo(); Type: FUNCTION; Schema: mod_estructuracomp; Owner: -
--
...
--
-- TOC entry 167 (class 1255 OID 1541008)
-- Dependencies: 1425 10
-- Name: ft_eliminar_nodoop(); Type: FUNCTION; Schema: mod_estructuracomp; Owner: -
--
...
--
-- TOC entry 168 (class 1255 OID 1541009)
-- Dependencies: 1425 10
-- Name: ft_insertar_fila(); Type: FUNCTION; Schema: mod_estructuracomp; Owner: -
--
...
--
-- TOC entry 169 (class 1255 OID 1541010)
-- Dependencies: 1425 10
-- Name: ft_insertar_nodo(); Type: FUNCTION; Schema: mod_estructuracomp; Owner: -
--
...
--
-- TOC entry 170 (class 1255 OID 1541011)
-- Dependencies: 1425 10
-- Name: ft_insertar_nodoop(); Type: FUNCTION; Schema: mod_estructuracomp; Owner: -
--
...
--
-- TOC entry 171 (class 1255 OID 1541012)
-- Dependencies: 1425 10
-- Name: ft_modificar_nodo(); Type: FUNCTION; Schema: mod_estructuracomp; Owner: -
--
...
--
-- TOC entry 172 (class 1255 OID 1541013)
-- Dependencies: 1425 10
-- Name: ft_modificar_nodoop(); Type: FUNCTION; Schema: mod_estructuracomp; Owner: -
--
...
CREATE OR REPLACE FUNCTION "mod_estructuracomp"."ft_actualizarsubordinacion" () RETURNS trigger AS
$body$
DECLARE
	 
	   estructura numeric;
	   estructurapadre numeric; 

	BEGIN

	   estructura = NEW.idestructura;
	   estructurapadre = NEW.idpadre;
	   
	   insert into mod_estructuracomp.dat_subordinacion
	   (idpadre, idhijo, idnomsubordinacion)
	   values(estructurapadre,estructura, 1);
...
CREATE TRIGGER "t_subordinacion" AFTER INSERT 
ON "mod_estructuracomp"."dat_estructura" FOR EACH ROW 
EXECUTE PROCEDURE "mod_estructuracomp"."ft_actualizarsubordinacion"();
