...
VALUES ('V6.0.0', 'V6.0.0','mod_estructuracomp','mod_datosmaestros','C','P','I');
----------------------------------------------------------------------------
...
GRANT USAGE
  ON SCHEMA "mod_estructuracomp" TO "loginuser";
----------------------------------------
...
GRANT USAGE
  ON "mod_datosmaestros"."sec_idconfiguracion_seq" TO "sauxe";
----------------------------------------
...
GRANT SELECT, INSERT, UPDATE, DELETE, TRIGGER
  ON "mod_datosmaestros"."conf_entidades" TO "sauxe";
