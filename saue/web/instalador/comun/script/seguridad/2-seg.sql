...
VALUES ('V6.0.0', 'V6.0.0','mod_seguridad',null,'C','E','I');	
...
--------------------------------------------------------------------------------
    ...
    CREATE SEQUENCE mod_seguridad.sec_nomtipoconexion_seq
	INCREMENT 1
	MINVALUE 1
	MAXVALUE 129999999999
	START 1
	CACHE 1;

-------------------------------------------------------
---Secuencias Creadas Por Jose Eduardo
-------------------------------------------------------
   CREATE SEQUENCE sec_datobjetobd_seq
    INCREMENT 1
    MINVALUE 12000000
    MAXVALUE 12999999 START 12000000
    CACHE 1;

CREATE SEQUENCE sec_datservicioioc_seq
    INCREMENT 1
    MINVALUE 12000000
    MAXVALUE 12999999 START 12000000
    CACHE 1;

CREATE SEQUENCE sec_objetobd
    INCREMENT 1
    MINVALUE 0
    MAXVALUE 12999999 START 0
    CACHE 1;

 CREATE SEQUENCE sec_segrolesbd_seq
    INCREMENT 1
    MINVALUE 0
    MAXVALUE 19999999999999 START 0
    CACHE 1; 

------Fin de las Secuencias Creadas por Jose Eduardo
...
CREATE TABLE dat_serautenticacion (
    idservidor numeric(19,0) NOT NULL,
    tservidor character varying(50),
    usuario character varying(255),
    clave   character varying(255),    
    basedn character varying(255),
    puerto numeric(8,0),
    ssl numeric(1,0) DEFAULT 0,
    tsl numeric(1,0) DEFAULT 0   	
);
...
CREATE TABLE seg_certificado(
  ...
  idcertificado numeric(19,0) NOT NULL DEFAULT nextval('mod_seguridad.sec_segcertificado_seq'::regclass), -- Llave primaria referente a la tabla seg_certificado
  mac character varying(255) NOT NULL,
  valor character varying(255) NOT NULL,
  idusuario numeric(19,0) NOT NULL, -- Llave foránea referente a la tabla seg_usuario
  fecha date,
  hora time(6) without time zone,
  idsession character varying(256),
  rol text,
  entidad text
);
...
CREATE TABLE seg_restricclaveacceso (
	...
	canthistorico integer DEFAULT 0 NOT NULL
);
...
(
  -----Modificada la longitud del atributo
...
CREATE TABLE mod_seguridad.dat_funcionalidades_restringidas_usuario_entidad_rol
(
  idsistema numeric(19,0) NOT NULL,
  idfuncionalidad numeric(19,0) NOT NULL,
  identidad numeric(19,0) NOT NULL,
...
-------------------------------------------------------
---Tablas Creadas Por Jose Eduardo
-------------------------------------------------------
CREATE TABLE dat_accion_dat_objetobd (
    idaccion numeric(19,0) NOT NULL,
    idobjetobd numeric(19,0) NOT NULL,
    privilegios character varying(6) NOT NULL
);

CREATE TABLE dat_accion_dat_servicioioc (
    idaccion numeric(19,0) NOT NULL,
    idservicio numeric(19,0) NOT NULL
);

CREATE TABLE dat_reglas (
    idfuncionalidadexcluida numeric(19,0) NOT NULL,
    idfuncionalidad numeric(19,0) NOT NULL
);

CREATE TABLE seg_rol_asignacion (
    idrol numeric NOT NULL,
    idrolasig numeric NOT NULL
);

CREATE TABLE dat_objetobd (
    idservidor numeric(19,0) NOT NULL,
    idgestor numeric(19,0) NOT NULL,
    idbd numeric(19,0) NOT NULL,
    idesquema numeric(19,0) NOT NULL,
    idobjetobd numeric(19,0) DEFAULT nextval('sec_datobjetobd_seq'::regclass) NOT NULL,
    idobjeto numeric(19,0) NOT NULL,
    objeto character varying NOT NULL,
    idrolesbd numeric(19,0) NOT NULL
);

CREATE TABLE dat_servicio_objetobd (
    idservicio numeric(19,0) NOT NULL,
    idobjetobd numeric(19,0) NOT NULL,
    privilegios character varying NOT NULL
);

CREATE TABLE dat_servicioioc (
    idservicio numeric(19,0) DEFAULT nextval('sec_datservicioioc_seq'::regclass) NOT NULL,
    denominacion character varying(150) NOT NULL,
    subsistema character varying(150) NOT NULL
);

CREATE TABLE nom_objetospermisos (
    id numeric DEFAULT nextval('sec_objetobd'::regclass) NOT NULL,
    nombreobjeto character varying NOT NULL,
    descripcion character varying,
    idobj numeric(2,0) NOT NULL
);

CREATE TABLE seg_rol_dat_servidor_dat_gestor (
    idrol numeric NOT NULL,
    idservidor numeric NOT NULL,
    idgestor numeric NOT NULL,
    denominacion character varying NOT NULL,
    idbd numeric(19,0) NOT NULL,
    idrolbd numeric(19,0) NOT NULL
);

CREATE TABLE seg_usuario_dat_servidor_dat_gestor (
    idusuario numeric(19,0) NOT NULL,
    idservidor numeric(19,0) NOT NULL,
    idgestor numeric(19,0) NOT NULL
);

CREATE TABLE mod_seguridad.nom_tipoconex
(
  idconexion numeric(15,0) NOT NULL DEFAULT nextval('mod_seguridad.sec_nomtipoconexion_seq'::regclass),
  seleccion boolean,
  denominacion character varying(100) NOT NULL,
  descripcion character varying(300),
  tipo numeric(3,0) NOT NULL
);
--------------Fin de las tablas Creadas por Jose Eduardo
...
ALTER TABLE mod_seguridad.dat_funcionalidades_restringidas_usuario_entidad_rol
  ADD CONSTRAINT pk_ent_usuario_rol_sist_func PRIMARY KEY(idsistema , idfuncionalidad , identidad , idrol , idusuario );

-------------------------------------------------------
---Llaves Primarias Creadas Por Jose Eduardo
-------------------------------------------------------
ALTER TABLE ONLY nom_objetospermisos
    ADD CONSTRAINT "Objetobd_pkey" PRIMARY KEY (id);

ALTER TABLE ONLY dat_reglas
    ADD CONSTRAINT dat_reglas_pkey PRIMARY KEY (idfuncionalidadexcluida, idfuncionalidad);

ALTER TABLE ONLY dat_servicio_objetobd
    ADD CONSTRAINT pk_dat_servicioobjetobd PRIMARY KEY (idservicio, idobjetobd);

ALTER TABLE ONLY dat_accion_dat_objetobd
    ADD CONSTRAINT pk_dataccion_datobjetobd PRIMARY KEY (idaccion, idobjetobd);

ALTER TABLE ONLY dat_accion_dat_servicioioc
    ADD CONSTRAINT pk_dataccion_datservicio PRIMARY KEY (idaccion, idservicio);

ALTER TABLE ONLY nom_tipoconex
    ADD CONSTRAINT pk_idconex PRIMARY KEY (idconexion);

ALTER TABLE ONLY dat_objetobd
    ADD CONSTRAINT pk_idobjetosbd PRIMARY KEY (idobjetobd);

ALTER TABLE ONLY dat_servicioioc
    ADD CONSTRAINT pk_idservicio PRIMARY KEY (idservicio);

ALTER TABLE ONLY seg_usuario_dat_servidor_dat_gestor
    ADD CONSTRAINT pk_idusuario_idserv_idgest PRIMARY KEY (idusuario, idservidor, idgestor);

ALTER TABLE ONLY seg_rol_dat_servidor_dat_gestor
    ADD CONSTRAINT pk_segroldatservdatgest PRIMARY KEY (idrol, idservidor, idgestor, denominacion, idbd, idrolbd);

ALTER TABLE ONLY seg_rol_asignacion
    ADD CONSTRAINT seg_rol_asignacion_pkey PRIMARY KEY (idrol, idrolasig);
-----Fin de las LLaves primarias Creadas por Jose Eduardo
...
ALTER TABLE mod_seguridad.dat_funcionalidades_restringidas_usuario_entidad_rol
  ADD CONSTRAINT "Ref_ent_user" FOREIGN KEY (idrol, identidad, idusuario)
      REFERENCES mod_seguridad.dat_entidad_seg_usuario_seg_rol (idrol, identidad, idusuario) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE CASCADE;

ALTER TABLE mod_seguridad.dat_funcionalidades_restringidas_usuario_entidad_rol
  ADD CONSTRAINT "Refdat_sistema_seg_rol_func_ent_user" FOREIGN KEY (idrol, idsistema, idfuncionalidad)
      REFERENCES mod_seguridad.dat_sistema_seg_rol_dat_funcionalidad (idrol, idsistema, idfuncionalidad) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE CASCADE;

-------------------------------------------------------
---Llaves Foraneas Creadas Por Jose Eduardo
-------------------------------------------------------
ALTER TABLE ONLY dat_accion_dat_objetobd
    ADD CONSTRAINT fk_idaccion FOREIGN KEY (idaccion) REFERENCES dat_accion(idaccion) ON DELETE CASCADE;
ALTER TABLE ONLY dat_accion_dat_objetobd
    ADD CONSTRAINT fk_idobjetobd FOREIGN KEY (idobjetobd) REFERENCES dat_objetobd(idobjetobd) ON DELETE CASCADE;

ALTER TABLE ONLY dat_accion_dat_servicioioc
    ADD CONSTRAINT fk_idaccion FOREIGN KEY (idaccion) REFERENCES dat_accion(idaccion) ON DELETE CASCADE;
ALTER TABLE ONLY dat_accion_dat_servicioioc
    ADD CONSTRAINT fk_idservicio FOREIGN KEY (idservicio) REFERENCES dat_servicioioc(idservicio) ON DELETE CASCADE;

ALTER TABLE ONLY seg_rol_asignacion
    ADD CONSTRAINT idroles FOREIGN KEY (idrol) REFERENCES seg_rol(idrol);

ALTER TABLE ONLY dat_objetobd
    ADD CONSTRAINT fk_idbd FOREIGN KEY (idbd) REFERENCES dat_bd(idbd) ON DELETE CASCADE;
ALTER TABLE ONLY dat_objetobd
    ADD CONSTRAINT fk_idrolesbd_datobjetobd FOREIGN KEY (idrolesbd) REFERENCES seg_rolesbd(idrolesbd) ON DELETE CASCADE;
ALTER TABLE ONLY dat_objetobd
    ADD CONSTRAINT idesquema FOREIGN KEY (idesquema) REFERENCES dat_esquema(idesquema) ON DELETE CASCADE;
ALTER TABLE ONLY dat_objetobd
    ADD CONSTRAINT idgestor FOREIGN KEY (idgestor) REFERENCES dat_gestor(idgestor) ON DELETE CASCADE;
ALTER TABLE ONLY dat_objetobd
    ADD CONSTRAINT idservidor FOREIGN KEY (idservidor) REFERENCES dat_servidor(idservidor) ON DELETE CASCADE;

ALTER TABLE ONLY dat_servicio_objetobd
    ADD CONSTRAINT fk_idobjetobddatservobjetobd FOREIGN KEY (idobjetobd) REFERENCES dat_objetobd(idobjetobd) ON DELETE CASCADE;
ALTER TABLE ONLY dat_servicio_objetobd
    ADD CONSTRAINT fk_idserviciodatservobjetobd FOREIGN KEY (idservicio) REFERENCES dat_servicioioc(idservicio) ON DELETE CASCADE;

ALTER TABLE ONLY seg_rol_dat_servidor_dat_gestor
    ADD CONSTRAINT fk_datgestor FOREIGN KEY (idgestor) REFERENCES dat_gestor(idgestor) ON DELETE CASCADE;
    
ALTER TABLE ONLY seg_rol_dat_servidor_dat_gestor 
   ADD CONSTRAINT fk_datservidor FOREIGN KEY (idservidor) REFERENCES dat_servidor(idservidor) ON DELETE CASCADE;
    
ALTER TABLE ONLY seg_rol_dat_servidor_dat_gestor 
   ADD CONSTRAINT fk_idbd FOREIGN KEY (idbd) REFERENCES dat_bd(idbd) ON DELETE CASCADE;
ALTER TABLE ONLY seg_rol_dat_servidor_dat_gestor
    ADD CONSTRAINT fk_idrol FOREIGN KEY (idrol) REFERENCES seg_rol(idrol) ON DELETE CASCADE;
ALTER TABLE ONLY seg_rol_dat_servidor_dat_gestor
    ADD CONSTRAINT idrolbd FOREIGN KEY (idrolbd) REFERENCES seg_rolesbd(idrolesbd) ON DELETE CASCADE;

ALTER TABLE ONLY seg_usuario_dat_servidor_dat_gestor
    ADD CONSTRAINT idgestor FOREIGN KEY (idgestor) REFERENCES dat_gestor(idgestor);
ALTER TABLE ONLY seg_usuario_dat_servidor_dat_gestor
    ADD CONSTRAINT idservidor FOREIGN KEY (idservidor) REFERENCES dat_servidor(idservidor) ON DELETE CASCADE;
ALTER TABLE ONLY seg_usuario_dat_servidor_dat_gestor
    ADD CONSTRAINT idusuarioserv FOREIGN KEY (idusuario) REFERENCES seg_usuario(idusuario) ON DELETE CASCADE;

----Fin de las LLaves Foraneas Creadas por Jose Eduardo
...
SELECT setval('mod_seguridad.sec_datsistema_seq', 30000, true);
SELECT setval('mod_seguridad.sec_datfuncionalidad_seq', 300000, true);
SELECT setval('mod_seguridad.sec_dataccion_seq', 3000000, true);	
