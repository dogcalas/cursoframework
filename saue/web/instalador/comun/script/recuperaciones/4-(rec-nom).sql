...
GRANT SELECT, USAGE ON TABLE mod_nomencladores.sec_iddpa TO sauxe;
GRANT SELECT, USAGE ON TABLE mod_nomencladores.sec_idespecialidad TO sauxe;
GRANT SELECT, USAGE ON TABLE mod_nomencladores.sec_idpais TO sauxe;
GRANT SELECT, USAGE ON TABLE mod_nomencladores.sec_idtipodpa TO sauxe;
----------------------------------------
--Permisos sobre tablas
----------------------------------------
	SET search_path = mod_nomencladores, pg_catalog;

GRANT SELECT ON TABLE mod_nomencladores.nom_dpa TO sauxe;
GRANT SELECT ON TABLE mod_nomencladores.nom_especialidad TO sauxe;
GRANT SELECT ON TABLE mod_nomencladores.nom_pais TO sauxe;
GRANT SELECT ON TABLE mod_nomencladores.nom_tipodpa TO sauxe;
