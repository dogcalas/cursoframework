...
GRANT USAGE
  ON SCHEMA "mod_datosmaestros" TO sauxe;
...
GRANT SELECT, USAGE ON TABLE mod_datosmaestros.sec_idconfiguracion_seq TO sauxe;
GRANT SELECT, USAGE ON TABLE mod_datosmaestros.sec_version_seq TO sauxe;
----------------------------------------
...
GRANT SELECT ON TABLE mod_datosmaestros.conf_entidades TO sauxe;
GRANT SELECT ON TABLE mod_datosmaestros.conf_version TO sauxe;
GRANT SELECT ON TABLE mod_datosmaestros.nom_secuenciasgeneral TO sauxe;
GRANT SELECT ON TABLE mod_datosmaestros.nom_servidor TO sauxe;
